...
<template>
    <v-card v-if="consultant" class="pa-4 mb-4">
      <v-card-title>Informations du Consultant</v-card-title>
      <v-card-text>
        <v-row>
          <v-col cols="12" >
            <v-avatar size="150">
          ...
          <v-col cols="12">
            ...
            <v-btn v-if="consultant.copyCI" :href="consultant.copyCI" prepend-icon="mdi-file" target="_blank" variant="outlined" color="primary">
              Voir le document
            </v-btn>
